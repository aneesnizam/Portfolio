...
export default function Nav({ closeBar, isNavOpen }) {
  //deferredPrompt, isInstall, removed
  // useEffect(() => {
  //   if (deferredPrompt) {
  ...
  return (
    <div>
      <section id="nav" className={isNavOpen ? "show" : ""}>
        ...
        <ul>
          <li className="cls">
            <button className="Closeside" onClick={closeBar}>
      ...
      <div id="overlay" onClick={closeBar}></div>
    </div>
  );
}
